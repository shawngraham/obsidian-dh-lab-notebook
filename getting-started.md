...
- make a daily note (there's a button in the toolbar) every day you're working on the course. Dump into that note thoughts, problems, issues, inspirations. 
- when you're working on a tutorial, create a new note, and insert the [[worksheet]] template to help keep track of your thoughts
- make notes as you read or think about the content of the course. One strategy is to make a new note for a unique thought/idea
